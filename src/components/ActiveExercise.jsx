      ...
      <table className="w-full">
        <thead className="font-bold">
          <tr className="text-gray-300 text-center">
            ...
            <th className="w-full flex justify-end pr-1">
              <Check size={32} color="#cbd5e1" weight="bold" />
            </th>
          </tr>
        </thead>
        ...
        <tfoot>
          <tr>
            <td colSpan="4">
              <button
                className="w-full bg-light rounded-lg mt-2 text-main font-bold p-1 text-sm"
