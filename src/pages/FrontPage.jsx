    ...
    <>
      ...
      <main className="flex flex-col justify-center items-center p-4">
        ...
        <div className="flex justify-between items-center p-4 text-center bg-light w-screen">
          <img src="https://safe-sets.fly.dev/api/files/2ksy4mcsdivkxma/mor8gop4rt56zyt/progression_PeTUmujDn8.WEBP" alt="screenshot" className="w-7/12 rounded-lg shadow-lg" />
        ...
        <div className="flex justify-between items-center p-4 text-center w-screen gap-4">
          ...
          <img src="https://safe-sets.fly.dev/api/files/2ksy4mcsdivkxma/2sj1scm51zizuqz/article_mzWMxSVAfb.WEBP" alt="screenshot" className="w-[100px] rounded-lg shadow-lg" />
        </div>
        <div className="flex justify-between items-center gap-4 p-4 text-center w-screen bg-light">
          <img src="https://safe-sets.fly.dev/api/files/2ksy4mcsdivkxma/o1w0po4tkt7stcr/history_y0jNddgza1.WEBP" alt="screenshot" className="w-[100px] rounded-lg shadow-lg" />
        ...
        <div className="flex justify-between items-center p-4 text-center w-screen gap-4">
          ...
          <img src="https://safe-sets.fly.dev/api/files/2ksy4mcsdivkxma/0qlizzkbvl5jwr2/exercises_eCgdNDDng5.WEBP" alt="screenshot" className="w-[100px] rounded-lg shadow-lg" />
        </div>
        <div className="flex justify-between items-center gap-4 p-4 text-center w-screen bg-light">
          <img src="https://safe-sets.fly.dev/api/files/2ksy4mcsdivkxma/csjcskabsvtaikg/workout_Iz1D2CGpor.WEBP" alt="screenshot" className="w-[100px] rounded-lg shadow-lg" />
